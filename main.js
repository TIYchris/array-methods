...
document.querySelector("#answer1").innerHTML +="<p>" + average + "</p>";
...
var priceTitles = filterPrice.forEach(function(item){
  document.querySelector("#answer2").innerHTML += "<p>" + item.title + "</p>";
});
 
//question 3

var currencyFilter = items.filter(function(item){
...
var filterTitle = currencyFilter.forEach(function(item){
  document.querySelector("#answer3").innerHTML += "<p>" + item.title + "  " + item.price + "&pound" + "</p>";
});
...
var woodTitle = woodFilter.forEach(function(item){
  document.querySelector("#answer4").innerHTML += "<p>" + item.title + "</p>";
});
 ...
 var filterMaterials = items.filter(function(item){
...
var meterialTitle = filterMaterials.forEach(function(item){ 
 document.querySelector("#answer5").innerHTML +=  
    "<p>" + item.title + "</p>" +
    "<p>" + "<div>" + item.quantity + "</div>" + "</p>" +
    "<p>" + "<div>" + item.materials.join("<br>")+ "</div>" + "</p>"
});
...
var whoMadeFilter = items.filter(function(item){
 ...
 document.querySelector("#answer6").innerHTML += "<p>" + whoMadeFilter.length + "</p>";
